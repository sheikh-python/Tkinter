...
class Menu(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # place the widgets
        menu_button1.grid(row=0, column=0, sticky='nswe', columnspan=2, padx=3, pady=4)
        menu_button2.grid(row=0, column=2, sticky='nswe', padx=3, pady=4)
        menu_button3.grid(row=1, column=0, columnspan=3, sticky='nsew', padx=3, pady=4)
...
App('Class based app with custom tkinter', (600, 600))
